...
function Navbar() {
  ...
  // Code when the page will be scrolled then the background colour will be changed
  ...
  return (
    <>
      <div className="navbar fixed top-0 right-0 z-40">
        <div
          className={`navbar   ${
            sticky
              ? "sticky-navbar shadow-md dark:bg-pink-400 dark:text-black bg-base-200 duration-300 ease-in-out rounded-lg"
              : ""
          }`}
        >
          ...
          <div className="navbar-end space-x-3">
            ...
            <div className="md:block hidden">
              <input
                ...
                className="border-2 rounded-md p-2 w-full max-w-xs"
              />
            </div>
